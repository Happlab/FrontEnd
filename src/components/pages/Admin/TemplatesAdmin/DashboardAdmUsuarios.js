  ...
  Inactivar(user) {
    ...
    peticion.then((data) => {
      if (data) {
        this.setState({
          notificacion: true,
          tituloNotificacion: "Gestion de usuarios",
          mensajeNotificacion:
            "El estado del usuario fue actualizado correctamente a inactivo",
        });
        this.ListarUsuarios();
      } else {
        this.setState({
          ...
          tituloNotificacion: "Gestion de usuarios",
          mensajeNotificacion:
            "El estado del usuario no fue posible actualizarlo, verifique su conexion con el servidor o a internet",
        });
      }
    });
  }
    ...
    peticion.then((data) => {
      if (data) {
        ...
        this.setState({
          ...
          tituloNotificacion: "Gestion de usuarios",
          mensajeNotificacion:
            "No fue posible rechazar la solicitud de este usuario, verifique su conexion con el servidor o a internet",
        });
      }
    });
  }
    ...
    peticion.then((data) => {
      if (data) {
        ...
        this.setState({
          ...
          tituloNotificacion: "Gestion de usuarios",
          mensajeNotificacion:
            "No fue posible aceptar la solicitud de este usuario, verifique su conexion con el servidor o a internet",
        });
      }
    });
  }
    ...
    peticion.then((data) => {
      if (data) {
        this.setState({
          ...
          tituloNotificacion: "Gestion de usuarios",
          mensajeNotificacion:
            "La estado del usuario cambió a activo correctamente",
        });
        this.ListarUsuarios();
      } else {
        this.setState({
          ...
          tituloNotificacion: "Gestion de usuarios",
          mensajeNotificacion:
            "No fue posible cambiar el estado del usuario, verifique su conexion con el servidor o a internet",
        });
      }
    });
  }
    ...
    datos.then((data) => {
      if (data !== null) {
        ...
        this.setState({
          notificacion: true,
          tituloNotificacion: "Gestion de usuarios",
          mensajeNotificacion: "No hay usuarios registrados",
        });
      }
    });
  }
