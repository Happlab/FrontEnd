    ...
    if (this.state.posicion !== -1) {
      ...
      peticion.then((data) => {
        if (data) {
          this.setState({
            notificacion: true,
            tituloNotificacion: "Gestion de informacion de Acerca de",
            mensajeNotificacion:
              "La informacion del apartado acerca de fue actualizada exitosamente",
          });
          this.listarInformacion();
        } else {
          this.setState({
            ...
            tituloNotificacion: "Gestion de informacion de Acerca de",
            mensajeNotificacion:
              "No fue posible editar la informacion de acerca de, verifique su conexion con el servidor o a internet",
          });
        }
      });
    }
                  ...
                  <div className="card">
                    <div className="card-header border-0">
                      <h3 className="card-title">
                        Listado de secciones (Acerca de)
                      </h3>
                    </div>
                        ...
                        <Form onSubmit={props.handleSubmit}>
                          ...
                          <Form.Group className="mb-3" controlId="inputLatitud">
                            ...
                            <Form.Control
                              ...
                              isInvalid={
                                props.touched.latitud && !!props.errors.latitud
                              }
