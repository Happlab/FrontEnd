...
class Contenido extends React.Component {
    ...
    datos
      .then((data) => {
        if (data !== null && data !== undefined) {
          this.setState({
            arrayContenidos: Array.from(data),
            estaCargando: false,
          });
        }
      })
  ...
  descarga(contenido_link) {
    if (this.credito !== 0) {
      ...
      this.setState({
        notificacion: true,
        tituloNotificacion: "Descarga de contenido",
        mensajeNotificacion:
      ...
      this.setState({
        notificacionContenido: true,
        tituloNotificacion: "Descarga de contenido",
        mensajeNotificacion: "No tiene creditos para esta accion",
      });
      this.peticion = 2;
    }
  }
  ...
  //                    </CardText>
  //                    <CardText className="subtittle-card">
  //                      {this.state.contenidosPorTag[i].id_autor.nombres}
  //                    </CardText>
  //                    <CardText className="stars-card">
  //                      <Rating
  //                        initialRating={
  //                          this.state.contenidosPorTag[i].valoracion_general
  //                        }
  //                        readonly
  //                        fractions={2}
  ...
  //                      />
  //                    </CardText>
  //                    <CardText className="content-card">
  //                      {" "}
  //                      {this.state.contenidosPorTag[i].tags}{" "}
  //                    </CardText>
  //                  </CardBody>
  //                  <Button
  //                    color="secondary"
  //                    onClick={() =>
  //                      this.handleClickEstadoTrue(
  //                        i,
  //                        this.state.contenidosPorTag[i].comentarios,
  //                        this.state.contenidosPorTag[i].titulo,
  //                        this.state.contenidosPorTag[i].id_autor.nombres +
  //                          " " +
  //                          this.state.contenidosPorTag[i].id_autor.apellidos,
  ...
  //                    </CardText>
  //                    <CardText className="subtittle-card">
  //                      {this.state.arrayContenidos[i].id_autor.nombres}
  //                    </CardText>
  //                    <CardText className="stars-card">
  //                      <Rating
  //                        initialRating={
  //                          this.state.arrayContenidos[i].valoracion_general
  //                        }
  //                        readonly
  //                        fractions={2}
  //                        emptySymbol="far fa-star fa-2x"
  ...
  //                        this.state.arrayContenidos[i].id_autor.nombres +
  //                          " " +
  //                          this.state.arrayContenidos[i].id_autor.apellidos,
  ...
  //              <h2 className="texto">Contenidos Educativos</h2>
  //            </div>
  //          </div>
  //        </div>
  //      </section>
  ...
  //            </ListGroup.Item>
  //            <ListGroup.Item
  //              onClick={() => this.handleClick("religion")}
  //              action
  //              className="item-filtro"
  //            >
  //              Religion
  //            </ListGroup.Item>
  //            <ListGroup.Item
  //              onClick={() => this.handleClick("ingles")}
  //              action
  //              className="item-filtro"
  //            >
  //              Ingles
  //            </ListGroup.Item>
  //            <ListGroup.Item
  //              onClick={() => this.handleClick("sociales")}
  //              action
  //              className="item-filtro"
  //            >
  //              Sociales
  ...
  //            <h5 className="titulo-Modal">
  //              {" "}
  //              Fecha de subida: {this.state.fecha}
  //            </h5>
  //          </Modal.Title>
  //          <Modal.Body>
  ...
  //                onClick={() =>
  //                  this.descarga(
  //                    this.state.arrayContenidos[this.state.posSeleccionado]
  //                      .link,
  //                    this.state.tokens
  //                  )
  //                }
  ...
  //                <p className="estrellitas">
  //                  {" "}
  //                  <Rating
  //                    initialRating={this.valoracion_usuario}
  //                    fractions={2}
  //                    emptySymbol="far fa-star fa-2x"
  //                    fullSymbol="fas fa-star fa-2x"
  //                    onChange={(rate) => this.CambiarRate(rate)}
  //                  />{" "}
  //                </p>
  //                <p>
  //                  {" "}
  ...
  //                    {" "}
  //                    <Rating
  //                      initialRating={this.state.comentarios[i]?.valoracion}
  //                      readonly
  //                      fractions={2}
  //                      emptySymbol="far fa-star fa-2x"
  //                      fullSymbol="fas fa-star fa-2x"
  ...
  //                  <CardText className="content-card">
  //                    {" "}
  //                    {this.state.comentarios[i]?.id_persona.nombres +
  //                      " " +
  //                      this.state.comentarios[i]?.id_persona.apellidos}{" "}
  //                  </CardText>
  //                  <CardText className="content-card">
  //                    {" "}
  //                    {this.state.comentarios[i]?.fecha_calificacion}{" "}
  //                  </CardText>
  //                  <CardText className="content-card">
  //                    {" "}
  //                    {this.state.comentarios[i]?.comentarios}
  //                  </CardText>
  //                </Card>
  //              );
  //            })}
        ...
        <section className="sec-filtros">
          <div className="filtros">
            <ul className="lista-filtros">
              ...
              <li className="item-filtro">Todas</li>
              <li className="item-filtro">Matematicas</li>
              <li className="item-filtro">Religion</li>
              <li className="item-filtro">Ingles</li>
              <li className="item-filtro">Sociales</li>

              {this.state.logeado && (
                <li className="item-filtro">
                  <button className="btn-busqueda">Subir documento</button>
                </li>
              )}
            </ul>
          </div>
          ...
          <div className="formulario">
            {this.state.estadoSubirContenido && (
              <form className="form-contenido">
                ...
                <div className="form-group">
                  <label>Resumen</label>
                  <textarea placeholder="Ingrese un resumen del material que desea subir" />
                </div>
                <div className="form-group">
                  <label>Autores</label>
                  <input
