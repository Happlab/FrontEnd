...
const Login = () => {
  ...
  const [isPressEye, setIsPressEye] = useState(false);
  ...
  const handleClickHiddenPassword = () => {
    ...
    const conditionIsPassword = inputPassword.type === "password";
    conditionIsPassword
      ? (inputPassword.type = "text")
      : (inputPassword.type = "password");
    setIsPressEye(conditionIsPassword);
  };
    ...
    onLogin(values.email, values.password)
      .then((data) => {
        if (data) {
          ...
          setTitleNotification("Inicio de Sesión");
          setMessageNotification(
            "Lo sentimos, no se pudo iniciar sesión. Verifique sus credenciales y si el error persiste, comuniquese con soporte técnico"
          );
        }
      })
      .finally(() => {
  ...
  const onRoute = () => {
    let index = 0;
    if (dataUser.rol[index] === "ADMIN")
      return <Navigate to="/adminInicio" state={{}} />;
    else if (dataUser.rol[index] === "USER")
  ...
  if (
    tokenUser !== null &&
    tokenUser.activo === false &&
    (tokenUser.rol[0] === "ADMIN" || tokenUser.rol[0] === "USER")
  )
  ...
  return (
    <MainPages>
      ...
      />
      {dataUser.activo && onRoute()}
      <section
        id="contenedor"
        className="elementor-section elementor-top-section elementor-element elementor-element-2bd9dc1 elementor-section-full_width elementor-section-height-full elementor-section-height-default elementor-section-items-middle"
        data-id="2bd9dc1"
        ...
        <div className="form-login">
          <form onSubmit={handleSubmit}>
            ...
            <div className="group-login">
              ...
              <div className="group-login-wrapper">
                <input
                  id="password-login"
                  name="password"
                  type="password"
                  ...
                  required
                />
                <button type="button" onClick={handleClickHiddenPassword}>
                  <span>{iconEye}</span>
                </button>
              </div>
            </div>
            <div className="group-login-footer">
