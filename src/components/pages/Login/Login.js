...
class Login extends React.Component {
      ...
      .then((data) => {
        if (data !== null && data !== undefined) {
          ...
          this.setState({
            ...
            mensajeNotificacion:
              "Error en el sistema, comuniquese con soporte tecnico",
          });
        else
          this.setState({
            notificacion: true,
  ...
  onRoute() {
    ...
    let index = 0;
    if (data.rol[index] === "ADMIN")
      return <Navigate to="/adminInicio" state={{}} />;
    else if (data.rol[index] === "USER")
  ...
  render() {
    ...
    if (
      data !== null &&
      valid_user === null &&
      (data.rol[0] === "ADMIN" || data.rol[0] === "USER")
    )
              ...
              <div className="group-login">
                ...
                <div className="group-login-wrapper">
                  <input
                    ...
                    required
                  />
                  <button type="button" onClick={this.handleClickOcultar}>
                    <span>{icono}</span>
                  </button>
                </div>
              </div>
